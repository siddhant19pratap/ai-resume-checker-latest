    ...
    <main className="min-h-screen bg-[#050816] text-white">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-sm font-semibold transition-all duration-200 shadow-lg shadow-blue-600/25 self-start sm:self-auto"
            >
          ...
          {loading ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  className="rounded-2xl p-6 animate-pulse" style={{ background: "#0a0f1e", border: "1px solid rgba(255,255,255,0.06)" }}
                >
            ...
            <div className="max-w-sm mx-auto text-center py-16">
              <div className="bg-[#0a0f1e] border border-white/[0.07] rounded-2xl p-10">
                ...
                {search ? (
                  ...
                  <button
                    onClick={() => navigate("/post-job")}
                    className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-sm font-medium transition-colors shadow-lg shadow-blue-600/20"
                  >
                    Post a Job
                  </button>
                )}
      ...
      {activeJob && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          {/* Panel */}
          <div
            className={`relative w-full max-w-[520px] flex flex-col bg-[#080d1a] border-l border-white/[0.07] shadow-2xl transition-transform duration-300 ease-out ${
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.07] shrink-0">
              <div className="flex items-center gap-2">
                {drawerView === "apply" && (
                  <button
                    ...
                    className="p-1.5 rounded-lg text-white/35 hover:text-white/70 transition-colors mr-1" style={{ background: "transparent" }}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={closeDrawer}
                className="p-2 rounded-xl text-white/35 hover:text-white/70 transition-all duration-200" style={{ background: "transparent" }}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                </svg>
              ...
              {drawerView === "detail" ? (
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-600/25 to-indigo-600/10 border border-blue-500/25 flex items-center justify-center shrink-0">
                      <span className="text-blue-300 font-bold text-xl">
                        {activeJob.company[0].toUpperCase()}
                      </span>
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-2.5">
                        ...
                        {activeJob.postedAt && (
                          <span className="text-xs text-white/25">
                            Posted {formatDate(activeJob.postedAt)}
                          </span>
                        )}
                      </div>
                    </div>
                ...
                <div className="flex flex-col items-center justify-center min-h-[420px] p-8 text-center">
                  ...
                  <p className="text-sm text-white/55 leading-relaxed">
                    ...
                    <span className="text-white font-medium">{activeJob.company}</span> has been
                    received.
                  </p>
                    ...
                    >
                      {resumeFile ? (
                        <>
                          ...
                          <p className="text-sm font-medium text-blue-300 text-center max-w-[220px] truncate">
                            {resumeFile.name}
                          </p>
